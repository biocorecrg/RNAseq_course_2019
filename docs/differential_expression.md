...
<br>
The first column is the sample name, the second column the file name of the count file generated by STAR (selecting the right column the right column), and the remaining columns are sample metadata which will be stored in ‘colData’.
<br>
<br>
<b>Exercise</b>
<br>
